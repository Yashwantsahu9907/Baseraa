...
import { Plus, Edit2, Trash2, Utensils, MapPin, IndianRupee, Bell, CheckCircle, XCircle, Users } from 'lucide-react';
                ...
                {bookings.length === 0 ? (
                    ...
                    <div key={booking._id} className="glass p-5 rounded-3xl bg-white shadow-xl shadow-slate-200/40 border border-slate-50">
                        ...
                        <div className="p-3 bg-slate-50 rounded-2xl text-[11px] text-slate-600 font-medium mb-4 flex items-center">
                            <Utensils className="w-3 h-3 mr-2 text-primary-400" /> Plan for: <span className="font-bold ml-1">{booking.propertyId?.name}</span>
                        </div>
